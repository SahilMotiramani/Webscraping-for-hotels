...
class HomePage(tk.Tk):
    ...
    def search(self):
        ...
        if file_data:
            self.withdraw()  # Hide the current homepage
            self.display_table(file_data)  # Display the table page for the searched city
        else:
    ...
    def on_table_close(self):
        self.deiconify()  # Show the hidden homepage
        self.table_window.destroy()  # Destroy the table page
